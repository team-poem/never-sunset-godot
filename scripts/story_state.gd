...
var ending: String = ""
var rules: Dictionary = {"landing:archive":{}, "landing:exit":{"next":"threshold"}, "threshold:worn":{"next":"ending"}, "threshold:new":{"next":"ending"},"pulse:count":{"next":"escape"}, "pulse:knock":{"next":"escape","exposure":1}, "escape:leave":{"next":"landing"}, "landing:elevator":{"exposure":1},"signal:off":{"next":"pulse"}, "signal:answer":{"next":"pulse","exposure":1},"drain:touch":{"next":"signal","exposure":1},"dusk:look":{"next":"drain","exposure":1},"return:mug":{"next":"dusk"}, "dusk:seal":{"next":"drain"}, "drain:cover":{"next":"signal"},"home:wash": {"next": "return"}}
